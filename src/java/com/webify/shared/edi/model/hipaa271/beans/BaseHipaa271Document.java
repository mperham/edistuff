 ...
 */
public abstract class BaseHipaa271Document extends EDITransaction {

	public static final String DOCUMENT_ID = "271";
	public static final List STANDARDS_IDS = new ArrayList();

	static {
		STANDARDS_IDS.add("004010X092A1,271");
	}
	...
	public void parse(EDIInputStream eis) throws IOException {
		if (log.isDebugEnabled()) log.debug("Starting loop 271");
		...
		while (eis.peekSegment("HL", 3, Loop2000A.TRIGGER_VALUES)) {
			...
			current2000A.setParent((Hipaa271Document)this);
	...
	public EDIElement createCopy() {
		Hipaa271Document thisCopy = new Hipaa271Document();
