 ...
 */
public class Field1203 {

	private static final Object[] DEFAULT_LEGAL_VALUES = new Object[10];
	private static final Map valueOverrides = new HashMap();

	static {
		DEFAULT_LEGAL_VALUES[0] = new String[] { "01", "49" };
		DEFAULT_LEGAL_VALUES[1] = new String[] { "4A", "4C" };
		DEFAULT_LEGAL_VALUES[2] = new String[] { "50", "73" };
		DEFAULT_LEGAL_VALUES[3] = new String[] { "75", "90" };
		DEFAULT_LEGAL_VALUES[4] = new String[] { "AA", "AJ" };
		DEFAULT_LEGAL_VALUES[5] = "XB";
		DEFAULT_LEGAL_VALUES[6] = "XI";
		DEFAULT_LEGAL_VALUES[7] = new String[] { "XL", "XN" };
		DEFAULT_LEGAL_VALUES[8] = "XT";
		DEFAULT_LEGAL_VALUES[9] = "ZZ";
		createOverrides();
	}
	...
	private static void createOverrides() {
		...
		currentValues[0] = "25";
		valueOverrides.put("47-4", currentValues);
