...
public class Field365 {
	...
	private static void createOverrides() {
		...
		currentValues[4] = "TE";
		currentValues[5] = "WP";
		valueOverrides.put("35-7", currentValues);
		...
		currentValues[2] = "TE";
		currentValues[3] = "WP";
		valueOverrides.put("44-5", currentValues);
		...
		currentValues[2] = "TE";
		currentValues[3] = "WP";
		valueOverrides.put("19-5", currentValues);
		...
		currentValues[4] = "TE";
		currentValues[5] = "WP";
		valueOverrides.put("60-7", currentValues);
		...
		currentValues[3] = "TE";
		currentValues[4] = "WP";
		valueOverrides.put("35-3", currentValues);
		...
		currentValues[4] = "TE";
		currentValues[5] = "WP";
		valueOverrides.put("35-5", currentValues);

		currentValues = new Object[3];
		currentValues[0] = "HP";
		currentValues[1] = "TE";
		currentValues[2] = "WP";
		valueOverrides.put("44-3", currentValues);
		...
		currentValues[4] = "TE";
		currentValues[5] = "WP";
		valueOverrides.put("60-5", currentValues);

		currentValues = new Object[3];
		currentValues[0] = "HP";
		currentValues[1] = "TE";
		currentValues[2] = "WP";
		valueOverrides.put("19-3", currentValues);
		...
		currentValues[3] = "FX";
		currentValues[4] = "TE";
		valueOverrides.put("7-7", currentValues);
		...
		currentValues[3] = "FX";
		currentValues[4] = "TE";
		valueOverrides.put("7-5", currentValues);
		...
		currentValues[2] = "TE";
		currentValues[3] = "WP";
		valueOverrides.put("19-7", currentValues);
		...
		currentValues[3] = "TE";
		currentValues[4] = "WP";
		valueOverrides.put("60-3", currentValues);
		...
		currentValues[2] = "TE";
		currentValues[3] = "WP";
		valueOverrides.put("44-7", currentValues);
	}
