...
public class Field365 {
	...
	private static void createOverrides() {
		...
		currentValues[0] = "EX";
		valueOverrides.put("33-7", currentValues);
		...
		currentValues[1] = "FX";
		currentValues[2] = "TE";
		valueOverrides.put("33-3", currentValues);
		...
		currentValues[2] = "FX";
		currentValues[3] = "TE";
		valueOverrides.put("33-5", currentValues);
		...
		currentValues[2] = "FX";
		currentValues[3] = "TE";
		valueOverrides.put("12-5", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "EX";
		valueOverrides.put("12-7", currentValues);
	}
