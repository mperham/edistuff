 ...
 */
public class SegmentN1_1 implements EDIElement {
	private static final Log log = LogFactory.getLog(SegmentN1_1.class);
	...
	public void parse(EDIInputStream eis) throws IOException {
		...
		N103 = eis.getStringValue(fields, 3, 1, 2, false);
		Field66.validateInputValue(eis, "N103", N103, ordinal, 3);
		N104 = eis.getStringValue(fields, 4, 2, 80, false);
		validate(eis);
	}
	...
	public EDIElement createCopy() {
		SegmentN1_1 copy = new SegmentN1_1();
