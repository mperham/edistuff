 ...
 */
public class SegmentNM1_10 implements EDIElement {
	private static final Log log = LogFactory.getLog(SegmentNM1_10.class);
	...
	public void parse(EDIInputStream eis) throws IOException {
		...
		Nm104 = eis.getStringValue(fields, 4, 1, 25, true);
		if (Nm104 == null || "".equals(fields[4].trim())) {
			eis.addError("Field 'NM104' missing");
		}
	...
	public void emit(EDIOutputStream eos) throws IOException {
		...
		if (Nm104 == null) {
			eos.addError("Emitting null mandatory field 'NM104'");
		}
	...
	public EDIElement createCopy() {
		SegmentNM1_10 copy = new SegmentNM1_10();
