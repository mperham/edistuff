 ...
 */
public abstract class BaseHipaa837iDocument extends EDITransaction {

	public static final String DOCUMENT_ID = "837i";
	public static final List STANDARDS_IDS = new ArrayList();

	static {
		STANDARDS_IDS.add("004010X096A1,837");
	}
	...
	public void parse(EDIInputStream eis) throws IOException {
		if (log.isDebugEnabled()) log.debug("Starting loop 837i");
		...
		while (eis.peekSegment("HL", 3, Loop2000A.TRIGGER_VALUES)) {
			...
			current2000A.setParent((Hipaa837iDocument)this);
	...
	public EDIElement createCopy() {
		Hipaa837iDocument thisCopy = new Hipaa837iDocument();
