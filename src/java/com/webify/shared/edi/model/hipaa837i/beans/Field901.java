...
public class Field901 {
	...
	private static void createOverrides() {
		...
		currentValues[0] = new String[] { "T1", "T6" };
		valueOverrides.put("78-13", currentValues);

		currentValues = new Object[1];
		currentValues[0] = new String[] { "T1", "T6" };
		valueOverrides.put("291-13", currentValues);

		currentValues = new Object[1];
		currentValues[0] = new String[] { "T1", "T6" };
		valueOverrides.put("295-13", currentValues);

		currentValues = new Object[1];
		currentValues[0] = new String[] { "T1", "T6" };
		valueOverrides.put("208-13", currentValues);
	}
