 ...
 */
public class Field921 {

	private static final Object[] DEFAULT_LEGAL_VALUES = new Object[6];
	private static final Map valueOverrides = new HashMap();

	static {
		DEFAULT_LEGAL_VALUES[0] = "AI";
		DEFAULT_LEGAL_VALUES[1] = "MS";
		DEFAULT_LEGAL_VALUES[2] = "OT";
		DEFAULT_LEGAL_VALUES[3] = "PT";
		DEFAULT_LEGAL_VALUES[4] = "SN";
		DEFAULT_LEGAL_VALUES[5] = "ST";
		createOverrides();
	}
