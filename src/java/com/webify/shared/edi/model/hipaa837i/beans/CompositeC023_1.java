 ...
 */
public class CompositeC023_1 implements EDICompositeField {
	...
	public void setC023_02(String val) {
		if (val == null) {
			throw new NullPointerException("Field 'C023_02' may not be null");
		}
	...
	public void setElements(String[] values) throws EDIParseException {
		...
		C023_01 = EDIUtils.getStringValue(values, 0, 1, 2, true);
		if (C023_01 == null) {
			throw new EDIParseException("Field 'C023_01' is mandatory");
		}
		C023_02 = EDIUtils.getStringValue(values, 1, 1, 2, true);
		...
		if (C023_02 == null) {
			throw new EDIParseException("Field 'C023_02' is mandatory");
		}
		C023_03 = EDIUtils.getStringValue(values, 2, 1, 1, true);
		if (C023_03 == null) {
			throw new EDIParseException("Field 'C023_03' is mandatory");
		}
	}
	...
	public void parse(EDIInputStream eis, String fieldValue) throws IOException {
		...
		C023_01 = eis.getStringValue(elements, 0, 1, 2, true);
		if (C023_01 == null) {
			eis.addError("Field 'C023_01' is mandatory");
		}
		C023_02 = eis.getStringValue(elements, 1, 1, 2, true);
		Field1332.validateInputValue(eis, "C023_02", C023_02, ordinal, 58);
		if (C023_02 == null) {
			eis.addError("Field 'C023_02' is mandatory");
		}
		C023_03 = eis.getStringValue(elements, 2, 1, 1, true);
		if (C023_03 == null) {
			eis.addError("Field 'C023_03' is mandatory");
		}
	}
	...
	public void emit(EDIOutputStream eos) throws IOException {
		eos.startComposite();
		if (C023_01 == null) {
			eos.addError("Emitting null mandatory field 'C023_01'");
		}
		eos.writeElement(C023_01);
		if (C023_02 == null) {
			eos.addError("Emitting null mandatory field 'C023_02'");
		}
		eos.writeElement(C023_02);
		if (C023_03 == null) {
			eos.addError("Emitting null mandatory field 'C023_03'");
		}
	...
	public EDIElement createCopy() {
		CompositeC023_1 copy = new CompositeC023_1();
