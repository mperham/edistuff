...
public class Field522 {
	...
	private static void createOverrides() {
		...
		currentValues = new Object[1];
		currentValues[0] = "MA";
		valueOverrides.put("178-1", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "PG";
		valueOverrides.put("236-1", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "B1";
		valueOverrides.put("108-1", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "PG";
		valueOverrides.put("106-1", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "T3";
		valueOverrides.put("232-1", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "B6";
		valueOverrides.put("231-1", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "C4";
		valueOverrides.put("230-1", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "C4";
		valueOverrides.put("100-1", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "B6";
		valueOverrides.put("101-1", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "AA";
		valueOverrides.put("107-1", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "N1";
		valueOverrides.put("234-1", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "F3";
		valueOverrides.put("46-1", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "YT";
		valueOverrides.put("240-1", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "KF";
		valueOverrides.put("235-1", currentValues);
	}
