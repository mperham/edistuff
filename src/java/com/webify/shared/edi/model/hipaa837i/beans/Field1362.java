...
public class Field1362 {
	...
	private static void createOverrides() {
		...
		currentValues[3] = "EM";
		currentValues[4] = "OA";
		valueOverrides.put("38-11-2", currentValues);
		...
		currentValues[3] = "EM";
		currentValues[4] = "OA";
		valueOverrides.put("168-11-1", currentValues);
		...
		currentValues[3] = "EM";
		currentValues[4] = "OA";
		valueOverrides.put("168-11-3", currentValues);
		...
		currentValues[3] = "EM";
		currentValues[4] = "OA";
		valueOverrides.put("38-11-3", currentValues);
		...
		currentValues[3] = "EM";
		currentValues[4] = "OA";
		valueOverrides.put("38-11-1", currentValues);
		...
		currentValues[3] = "EM";
		currentValues[4] = "OA";
		valueOverrides.put("168-11-2", currentValues);
	}
