...
import com.webify.shared.edi.model.hipaa837i.beans.BaseLoop2010AA;
...
public class Loop2010AA extends BaseLoop2010AA {
    ...
    public ProviderInfo getProviderInfo() {
        if (providerInfo == null) {
            providerInfo = new ProviderInfo() {
                public OrganizationInfo getOrganizationInfo() {
                    return Loop2010AA.this.getOrganizationInfo();
                }

                public AddressInfo getAddressInfo() {
                    return Loop2010AA.this.getAddressInfo();
                }

                public String getPrimaryIdentifier() {
                    return Loop2010AA.this.getPrimaryIdentifier();
                }
            };
        }
        return providerInfo;
    ...
    private SegmentREF_1 findSsnOrEin() {
        for (int i = 0; i < getRef01().size(); ++i) {
            SegmentREF_1 ref = getRef01(i);
