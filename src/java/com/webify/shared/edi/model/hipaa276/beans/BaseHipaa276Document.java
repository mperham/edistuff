 ...
 */
public abstract class BaseHipaa276Document extends EDITransaction {

	public static final String DOCUMENT_ID = "276";
	public static final List STANDARDS_IDS = new ArrayList();

	static {
		STANDARDS_IDS.add("004010X093A1,276");
	}
	...
	public void parse(EDIInputStream eis) throws IOException {
		if (log.isDebugEnabled()) log.debug("Starting loop 276");
		...
		while (eis.peekSegment("HL", 3, Loop2000A.TRIGGER_VALUES)) {
			...
			current2000A.setParent((Hipaa276Document)this);
	...
	public EDIElement createCopy() {
		Hipaa276Document thisCopy = new Hipaa276Document();
