 ...
 */
public class Field1570 {

	private static final Object[] DEFAULT_LEGAL_VALUES = new Object[8];
	private static final Map valueOverrides = new HashMap();

	static {
		DEFAULT_LEGAL_VALUES[0] = "ASB";
		DEFAULT_LEGAL_VALUES[1] = "ASC";
		DEFAULT_LEGAL_VALUES[2] = "B64";
		DEFAULT_LEGAL_VALUES[3] = "HDC";
		DEFAULT_LEGAL_VALUES[4] = "NOF";
		DEFAULT_LEGAL_VALUES[5] = "R64";
		DEFAULT_LEGAL_VALUES[6] = "UUE";
		DEFAULT_LEGAL_VALUES[7] = "ZZZ";
		createOverrides();
	}
