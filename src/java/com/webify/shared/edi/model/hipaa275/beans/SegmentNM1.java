 ...
 */
public class SegmentNM1 implements EDIElement {
	private static final Log log = LogFactory.getLog(SegmentNM1.class);
	...
	public String getNm110() { return Nm110; }
	public void setNm110(String val) {
		if (Field706.validateValue(val)) {
			Nm110 = val;
		} else {
			throw new IllegalArgumentException("Field 'NM110' cannot have value: " + val);
		}
	}

	private String Nm111;
	public String getNm111() { return Nm111; }
	public void setNm111(String val) {
		if (Field98.validateValue(val)) {
			Nm111 = val;
		} else {
			throw new IllegalArgumentException("Field 'NM111' cannot have value: " + val);
		}
	}

	private String Nm112;
	public String getNm112() { return Nm112; }
	public void setNm112(String val) { Nm112 = val; }
	...
	public void parse(EDIInputStream eis) throws IOException {
		...
		Nm103 = eis.getStringValue(fields, 3, 1, 60, false);
		Nm104 = eis.getStringValue(fields, 4, 1, 35, false);
		...
		Nm110 = eis.getStringValue(fields, 10, 2, 2, false);
		Field706.validateInputValue(eis, "NM110", Nm110, ordinal, 10);
		Nm111 = eis.getStringValue(fields, 11, 2, 3, false);
		Field98.validateInputValue(eis, "NM111", Nm111, ordinal, 11);
		Nm112 = eis.getStringValue(fields, 12, 1, 60, false);
		validate(eis);
	}
	...
	protected void validate(EDIInputStream eis) {
		...
		if (Nm111 != null) {
			if (Nm110 == null) {
				eis.addError("If 'Nm111' is set, the following must be set also: Nm110");
			}
		}
		...
		if (Nm112 != null) {
			if (Nm103 == null) {
				eis.addError("If 'Nm112' is set, the following must be set also: Nm103");
			}
		}
	...
	public void emit(EDIOutputStream eos) throws IOException {
		...
		eos.writeField(Nm110);
		eos.writeField(Nm111);
		eos.writeField(Nm112);
		eos.endSegment();
	}

	public EDIElement createCopy() {
		SegmentNM1 copy = new SegmentNM1();
		...
		copy.Nm110 = this.Nm110;
		copy.Nm111 = this.Nm111;
		copy.Nm112 = this.Nm112;
		return copy;
	}
}
