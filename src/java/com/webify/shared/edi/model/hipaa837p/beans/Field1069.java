...
public class Field1069 {
	...
	private static void createOverrides() {
		...
		currentValues[6] = "15";
		currentValues[7] = "17";
		currentValues[8] = new String[] { "19", "24" };
		currentValues[9] = "29";
		currentValues[10] = new String[] { "32", "34" };
		currentValues[11] = "36";
		...
		currentValues[0] = "18";
		valueOverrides.put("25-2", currentValues);
		...
		currentValues[13] = "53";
		currentValues[14] = "G8";
		valueOverrides.put("307-2", currentValues);
		...
		currentValues[13] = "53";
		currentValues[14] = "G8";
		valueOverrides.put("113-2", currentValues);
	}
