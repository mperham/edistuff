 ...
 */
public class BaseLoop2420C extends EDILoop {
	...
	// Segments
	private SegmentNM1_7 Nm1;
	public SegmentNM1_7 getNm1() { return Nm1; }
	public void setNm1(SegmentNM1_7 seg) { Nm1 = seg; }
	...
	public void parse(EDIInputStream eis) throws IOException {
		if (log.isDebugEnabled()) log.debug("Starting loop 2420C");
		startLineNumber = eis.getCurrentSegmentNumber() + 1;

		if (eis.peekSegment("NM1")) {
			Nm1 = new SegmentNM1_7();
			Nm1.setOrdinal(400);
			Nm1.parse(eis);
		}
	...
	public EDIElement createCopy() {
		Loop2420C thisCopy = new Loop2420C();
		thisCopy.setStartLineNumber(this.startLineNumber);
		thisCopy.setEndLineNumber(this.endLineNumber);

		if (Nm1 != null) {
			thisCopy.setNm1((SegmentNM1_7)Nm1.createCopy());
		}
