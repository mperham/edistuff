...
public class Field1068 {
	...
	private static void createOverrides() {
		...
		currentValues[1] = "M";
		currentValues[2] = "U";
		valueOverrides.put("31-3", currentValues);

		currentValues = new Object[3];
		currentValues[0] = "F";
		currentValues[1] = "M";
		currentValues[2] = "U";
		valueOverrides.put("125-3", currentValues);

		currentValues = new Object[3];
		currentValues[0] = "F";
		currentValues[1] = "M";
		currentValues[2] = "U";
		valueOverrides.put("319-3", currentValues);

		currentValues = new Object[3];
		currentValues[0] = "F";
		currentValues[1] = "M";
		currentValues[2] = "U";
		valueOverrides.put("237-3", currentValues);
	}
