...
public class Field355 {
	...
	private static void createOverrides() {
		...
		currentValues[0] = "01";
		valueOverrides.put("26-7", currentValues);
		...
		currentValues[2] = "ML";
		currentValues[3] = "UN";
		valueOverrides.put("437-5-1", currentValues);
		...
		currentValues[1] = "MJ";
		currentValues[2] = "UN";
		valueOverrides.put("153-3", currentValues);

		currentValues = new Object[3];
		currentValues[0] = "F2";
		currentValues[1] = "MJ";
		currentValues[2] = "UN";
		valueOverrides.put("347-3", currentValues);
		...
		currentValues[2] = "Q1";
		currentValues[3] = "WK";
		valueOverrides.put("392-3", currentValues);
		...
		currentValues[2] = "Q1";
		currentValues[3] = "WK";
		valueOverrides.put("288-3", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "DA";
		valueOverrides.put("435-2", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "DH";
		valueOverrides.put("280-5", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "DH";
		valueOverrides.put("350-5", currentValues);
		...
		currentValues[2] = "ML";
		currentValues[3] = "UN";
		valueOverrides.put("431-5-1", currentValues);
		...
		currentValues[2] = "Q1";
		currentValues[3] = "WK";
		valueOverrides.put("198-3", currentValues);
		...
		currentValues[2] = "WK";
		currentValues[3] = "YR";
		valueOverrides.put("351-5", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "DH";
		valueOverrides.put("156-5", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "LB";
		valueOverrides.put("350-1", currentValues);
		...
		currentValues[2] = "WK";
		currentValues[3] = "YR";
		valueOverrides.put("157-5", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "DA";
		valueOverrides.put("430-2", currentValues);
		...
		currentValues[2] = "WK";
		currentValues[3] = "YR";
		valueOverrides.put("281-5", currentValues);
		...
		currentValues[2] = "Q1";
		currentValues[3] = "WK";
		valueOverrides.put("94-3", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "DH";
		valueOverrides.put("86-5", currentValues);

		currentValues = new Object[2];
		currentValues[0] = "DA";
		currentValues[1] = "UN";
		valueOverrides.put("393-11", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "MO";
		valueOverrides.put("158-2", currentValues);
		...
		currentValues[2] = "WK";
		currentValues[3] = "YR";
		valueOverrides.put("87-5", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "MO";
		valueOverrides.put("352-2", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "01";
		valueOverrides.put("232-7", currentValues);

		currentValues = new Object[2];
		currentValues[0] = "DA";
		currentValues[1] = "UN";
		valueOverrides.put("199-11", currentValues);
	}
