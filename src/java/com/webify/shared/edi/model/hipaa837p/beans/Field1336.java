...
public class Field1336 {
	...
	static {
		DEFAULT_LEGAL_VALUES[0] = new String[] { "12", "16" };
		DEFAULT_LEGAL_VALUES[1] = new String[] { "41", "43" };
		DEFAULT_LEGAL_VALUES[2] = "47";
		DEFAULT_LEGAL_VALUES[3] = "AP";
		DEFAULT_LEGAL_VALUES[4] = "C1";
		DEFAULT_LEGAL_VALUES[5] = "CO";
		DEFAULT_LEGAL_VALUES[6] = "CP";
		DEFAULT_LEGAL_VALUES[7] = "D";
	...
	private static void createOverrides() {
		...
		currentValues[1] = new String[] { "41", "43" };
		currentValues[2] = "47";
		...
		currentValues[13] = "PP";
		currentValues[14] = "SP";
		valueOverrides.put("307-5", currentValues);
		...
		currentValues[13] = "PP";
		currentValues[14] = "SP";
		valueOverrides.put("113-5", currentValues);
	}
