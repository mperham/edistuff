...
public class Field1221 {
	...
	private static void createOverrides() {
		...
		currentValues = new Object[1];
		currentValues[0] = "RF";
		valueOverrides.put("290-1", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "PE";
		valueOverrides.put("395-1", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "RF";
		valueOverrides.put("415-1", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "RF";
		valueOverrides.put("96-1", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "PE";
		valueOverrides.put("201-1", currentValues);
	}
