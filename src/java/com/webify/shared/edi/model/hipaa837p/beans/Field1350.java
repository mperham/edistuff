...
public class Field1350 {
	...
	private static void createOverrides() {
		...
		currentValues[0] = "1";
		valueOverrides.put("159-13", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "1";
		valueOverrides.put("353-13", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "3";
		valueOverrides.put("159-15", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "3";
		valueOverrides.put("353-15", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "2";
		valueOverrides.put("353-14", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "2";
		valueOverrides.put("159-14", currentValues);
	}
