...
public class Field901 {
	...
	private static void createOverrides() {
		...
		valueOverrides.put("286-13", currentValues);

		currentValues = new Object[1];
		currentValues[0] = new String[] { "T1", "T6" };
		valueOverrides.put("199-13", currentValues);

		currentValues = new Object[1];
		currentValues[0] = new String[] { "T1", "T6" };
		valueOverrides.put("92-13", currentValues);

		currentValues = new Object[1];
		currentValues[0] = new String[] { "T1", "T6" };
		valueOverrides.put("393-13", currentValues);
	}
