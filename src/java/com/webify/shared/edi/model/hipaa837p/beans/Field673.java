...
public class Field673 {
	...
	private static void createOverrides() {
		...
		currentValues[4] = "HO";
		currentValues[5] = "HP";
		currentValues[6] = new String[] { "P3", "P5" };
		currentValues[7] = "SG";
		valueOverrides.put("372-1", currentValues);
		...
		currentValues = new Object[1];
		currentValues[0] = "VS";
		valueOverrides.put("198-1", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "VS";
		valueOverrides.put("288-1", currentValues);

		currentValues = new Object[1];
		currentValues[0] = "VS";
		valueOverrides.put("392-1", currentValues);
	}
