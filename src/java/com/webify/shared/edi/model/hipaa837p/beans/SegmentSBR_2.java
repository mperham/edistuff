 ...
 */
public class SegmentSBR_2 implements EDIElement {
	private static final Log log = LogFactory.getLog(SegmentSBR_2.class);
	...
	public void setSbr02(String val) {
		if (val == null) {
			throw new NullPointerException("Field 'SBR02' may not be null");
		}
	...
	public String getSbr05() { return Sbr05; }
	public void setSbr05(String val) {
		if (val == null) {
			throw new NullPointerException("Field 'SBR05' may not be null");
		}
		if (Field1336.validateValue(val)) {
			Sbr05 = val;
		} else {
			throw new IllegalArgumentException("Field 'SBR05' cannot have value: " + val);
		}
	}
	...
	public void parse(EDIInputStream eis) throws IOException {
		...
		Sbr02 = eis.getStringValue(fields, 2, 2, 2, true);
		Field1069.validateInputValue(eis, "SBR02", Sbr02, ordinal, 2);
		if (Sbr02 == null || "".equals(fields[2].trim())) {
			eis.addError("Field 'SBR02' missing");
		}
		Sbr03 = eis.getStringValue(fields, 3, 1, 30, false);
		Sbr04 = eis.getStringValue(fields, 4, 1, 60, false);
		Sbr05 = eis.getStringValue(fields, 5, 1, 3, true);
		Field1336.validateInputValue(eis, "SBR05", Sbr05, ordinal, 5);
		if (Sbr05 == null || "".equals(fields[5].trim())) {
			eis.addError("Field 'SBR05' missing");
		}
	...
	public void emit(EDIOutputStream eos) throws IOException {
		...
		if (Sbr02 == null) {
			eos.addError("Emitting null mandatory field 'SBR02'");
		}
		...
		if (Sbr05 == null) {
			eos.addError("Emitting null mandatory field 'SBR05'");
		}

		eos.writeField(Sbr05);
		eos.writeNullField();
		eos.writeNullField();
		eos.writeNullField();
