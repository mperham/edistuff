...
public class Field365 {
	...
	private static void createOverrides() {
		...
		currentValues[3] = "FX";
		currentValues[4] = "TE";
		valueOverrides.put("6-5", currentValues);
		...
		currentValues[3] = "FX";
		currentValues[4] = "TE";
		valueOverrides.put("329-5", currentValues);

		currentValues = new Object[3];
		currentValues[0] = "EM";
		currentValues[1] = "FX";
		currentValues[2] = "TE";
		valueOverrides.put("18-3", currentValues);
		...
		currentValues[3] = "FX";
		currentValues[4] = "TE";
		valueOverrides.put("135-5", currentValues);
		...
		currentValues[2] = "FX";
		currentValues[3] = "TE";
		valueOverrides.put("18-7", currentValues);
		...
		currentValues[2] = "FX";
		currentValues[3] = "TE";
		valueOverrides.put("219-7", currentValues);
		...
		currentValues[2] = "FX";
		currentValues[3] = "TE";
		valueOverrides.put("329-3", currentValues);
		...
		currentValues[2] = "FX";
		currentValues[3] = "TE";
		valueOverrides.put("413-5", currentValues);
		...
		currentValues[3] = "FX";
		currentValues[4] = "TE";
		valueOverrides.put("6-7", currentValues);
		...
		currentValues[3] = "FX";
		currentValues[4] = "TE";
		valueOverrides.put("329-7", currentValues);
		...
		currentValues[3] = "FX";
		currentValues[4] = "TE";
		valueOverrides.put("135-7", currentValues);

		currentValues = new Object[3];
		currentValues[0] = "EM";
		currentValues[1] = "FX";
		currentValues[2] = "TE";
		valueOverrides.put("219-3", currentValues);
		...
		currentValues[2] = "FX";
		currentValues[3] = "TE";
		valueOverrides.put("219-5", currentValues);

		currentValues = new Object[3];
		currentValues[0] = "EM";
		currentValues[1] = "FX";
		currentValues[2] = "TE";
		valueOverrides.put("413-3", currentValues);
		...
		currentValues[2] = "FX";
		currentValues[3] = "TE";
		valueOverrides.put("413-7", currentValues);
		...
		currentValues[2] = "FX";
		currentValues[3] = "TE";
		valueOverrides.put("135-3", currentValues);
	}
