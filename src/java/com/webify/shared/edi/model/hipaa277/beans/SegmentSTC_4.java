 ...
 */
public class SegmentSTC_4 implements EDIElement {
	private static final Log log = LogFactory.getLog(SegmentSTC_4.class);
	...
	public void parse(EDIInputStream eis) throws IOException {
		...
		Stc04 = eis.getDecimalValue(fields, 4, true);
		if (Stc04 == null || "".equals(fields[4].trim())) {
			eis.addError("Field 'STC04' missing");
		}
		Stc05 = eis.getDecimalValue(fields, 5, true);
		if (Stc05 == null || "".equals(fields[5].trim())) {
			eis.addError("Field 'STC05' missing");
		}
	...
	public void emit(EDIOutputStream eos) throws IOException {
		...
		eos.writeNullField();
		if (Stc04 == null) {
			eos.addError("Emitting null mandatory field 'STC04'");
		}

		eos.writeField(Stc04);
		if (Stc05 == null) {
			eos.addError("Emitting null mandatory field 'STC05'");
		}
	...
	public EDIElement createCopy() {
		SegmentSTC_4 copy = new SegmentSTC_4();
