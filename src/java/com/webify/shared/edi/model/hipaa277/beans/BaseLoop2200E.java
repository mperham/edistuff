...
public class BaseLoop2200E extends EDILoop {
	...
	// Loops
	private List loop2220E;
	public Loop2220E getLoop2220E(int idx) { 
		if (loop2220E == null || idx >= loop2220E.size()) {
			throw new ArrayIndexOutOfBoundsException("loop2220E");
		}
		return (Loop2220E) loop2220E.get(idx);
	}
	public List getLoop2220E() {
		return loop2220E;
	}
	public void setLoop2220E(List loop) { loop2220E = loop; }
	...
	public void parse(EDIInputStream eis) throws IOException {
		...
		while (true) {
			if (eis.peekSegment("SVC")) {
				if (loop2220E == null) loop2220E = new ArrayList();
				Loop2220E tmp = new Loop2220E();
				tmp.parse(eis);
				loop2220E.add(tmp);
			}
			else {
	...
	public void emit(EDIOutputStream eos) throws IOException {
		...
		if (Ref01 != null) {
			...
			eos.addError("Missing mandatory segment 'REF01'");
		}
		...
		if (loop2220E != null) {
			int idx = 0, size = loop2220E.size();
			while (idx < size) {
				getLoop2220E(idx++).emit(eos);
			}
		}
	...
	public EDIElement createCopy() {
		...
		if (loop2220E != null) {
			thisCopy.setLoop2220E(new ArrayList());
			int idx = 0, size = loop2220E.size();
			while (idx < size) {
				thisCopy.getLoop2220E().add(getLoop2220E(idx++).createCopy());
			}
		}
