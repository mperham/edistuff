 ...
 */
public class BaseLoop2220D extends EDILoop {
	...
	private SegmentSTC_3 Stc;
	public SegmentSTC_3 getStc() { return Stc; }
	public void setStc(SegmentSTC_3 seg) { Stc = seg; }
	...
	public void parse(EDIInputStream eis) throws IOException {
		if (log.isDebugEnabled()) log.debug("Starting loop 2220D");
	...
	public EDIElement createCopy() {
		Loop2220D thisCopy = new Loop2220D();
		...
		if (Stc != null) {
			thisCopy.setStc((SegmentSTC_3)Stc.createCopy());
		}
